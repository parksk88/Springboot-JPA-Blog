...
public class DummyControllerTest {
	...
	public String delete(@PathVariable int id) {
		...
		} catch (EmptyResultDataAccessException e) { //Exception 걸어도
	...
	//트랜잭셔널을 걸면 51번째줄 userRepository.save(user);을 주석하고도 업데이트가 된다.
...
//		}
	...
	public User detail(@PathVariable int id) {
		...
		//findById(id).get(); 은 무조건 가져오는건데 db에 없을수도 있어서 위험하다.
